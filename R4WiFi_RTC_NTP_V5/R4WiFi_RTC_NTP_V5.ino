/*
 * R4WiFi_RTC_NTP_V5.ino (privately known as: Arduino_UNO_WiFi_R4__RTC_NTP_V5.ino)
 ...
 * The UNO R4 WiFi does not have actual EEPROM, it is emulated in flash memory, and is 8K bytes in size. For the moment these functions are disabled.
 ...
 * Update 2025-10-27. Added dst awarenesss (for Portugal timezone)
 */

#include <RTC.h> // See: "C:\Users\<User>\AppData\Local\Arduino15\packages\arduino\hardware\renesas_uno\1.5.1\libraries\RTC\src\RTC.h"
#include <Arduino.h>
